...
switch (@$task)
{
	case 'registracija':
		...
		{	
			...
			$link = "http://topolino.ddns.net/regprocess.php?task=aktivacija&u=".$idd."&id=".md5($username)."";
			...
			$message =
				...
				Link sajta: <a href='http://morenja.info'>http://morenja.info</a><br /><br />
				
				---------<br />
				".$jezik['text177']."<br />
				Vas <b>Morenja Hosting!</b>";
				
				
			###
			$headers  = 'MIME-Version: 1.0' . "\r\n";
			$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
			$headers .= 'From: Morenja Hosting <podrska@'.$_SERVER['SERVER_NAME'].'>' . "\r\n";
