		...
		<tr>
			<td>
				...
				<div id="infos">
					...
					<p id="h2"><i class="icon-bar-chart"></i> <?php echo $jezik['text386']; ?>: <a target="_BLANK" href="http://morenja.info/grafik/<?php echo $boxip['ip'].'_'.$server['port']; ?>.png"><z style="font-size: 9px;">http://morenja.info/grafik/<?php echo $boxip['ip'].'_'.$server['port']; ?>.png</z></a></p>
				</div>							
			</td>
