...
if(!defined('DBUSER')) define("DBUSER", 'gpanel'); 
if(!defined('DBPASS')) define("DBPASS", '123123123123');
if(!defined('CHARSET')) define("CHARSET", 'utf8');
if(!defined('DOMEN')) define("DOMEN", 'www.domen.com');
...
$config['paypal']['email'] = "paypal@domen.com";

// BOOST PODATKE
//if(!defined('BOOST_HOST')) define("BOOST_HOST", 'host1.domen.com');
//if(!defined('BOOST_DBNAME')) define("BOOST_DBNAME", 'csdownload_master');
//if(!defined('BOOST_DBUSER')) define("BOOST_DBUSER", 'master'); 
//if(!defined('BOOST_DBPASS')) define("BOOST_DBPASS", '123123123123');
