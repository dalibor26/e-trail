...
<head>
    <meta charset="utf-8">
    <title><?php echo $naslov; ?> :: E-Trail Hosting</title>
    
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    <meta name="apple-mobile-web-app-capable" content="yes">    
    
    <link href="<?php echo $dir; ?>/assets/css/bootstrap.css" rel="stylesheet" type="text/css">
    ...
    <link href="<?php echo $dir; ?>/assets/css/etrail.css" rel="stylesheet" type="text/css">
    ...
    <link href="<?php echo $dir; ?>/assets/css/custom.css" rel="stylesheet" type="text/css">	
				...
				<ul class="nav pull-right">			
					...
					<li class="dropdown">					
						...
						<ul class="dropdown-menu">
							<li><a href="<?php echo $dir; ?>/profil">Profil podešavanja</a></li>
							<li class="divider"></li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li class="divider"></li>
							<li><a href="<?php echo $dir; ?>/mojprofil"><i class="icon-fixed-width icon-user"></i> Moj profil</a></li>
							<li class="divider"></li>
					...
					<li class="dropdown<?php if($fajl == "klijenti") echo' active';  ?>">					
						...
						<ul class="dropdown-menu">
							...
							<li><a href="klijenti.php?view=all">Svi klijenti (<m><?php echo $brcall; ?></m>)</a></li>
                                                        <li><a href="knovac.php">Klijenti - Novac (<m><?php echo $brnovac_all; ?></m>)</a></li>
