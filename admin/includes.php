...
function srvgrafik($ip, $port) {
	...
	$grafik = '<span class="autor" data-selector="true" data-content="<img src=\'http://morenja.info/grafik/'.$ipport.'.png\' />" style="color: #95A1AB">' . $ip . ':<m>' . $port . '</m></span>';
...
function admin_avatar($id) {
	...
	return "http://morenja.info/admin/avatari/{$av}";	
}
...
function user_avatar($id) {
	...
	return "http://morenja.info/avatari/{$query[avatar]}";	
}
