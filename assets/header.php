...
<head>
    ...
    <title><?php if(!empty($naslov)) echo $naslov; else echo 'Klijent'; ?> :: E-Trail Hosting</title>

    <meta name="description" content="Zakupite svoj game server po veoma niskoj ceni sa veoma visokim kvalitetom!">
    <meta name="keywords" content="morenja, hosting, prodaja, host, cs 1.6, samp, Counter-Strike 1.6, San Andreas Multiplayer, najjeftiniji hosting, game hosting, game serveri, gamepanel" />
                                    ...
                                    <div id="freq<?php echo $row['id']; ?>" style="cursor: default;" <?php if($row['status']==1) echo ' class="unread"'; ?>>
                                        <li>
                                            <table>
                                                <tr valign="top">
                                                    <td width="55">
                                                        <img style="margin: -8px;" width="55" height="55" src="http://46.105.57.49/avatar.php?mode=c&id=<?php echo $row['user_one']; ?>" />
                                                    </td>
                                                    <td>
...
?>
    ...
    ?>
                        <a href="http://e-trail.eu/<?php echo "{$fajlxx}?{$_SERVER['QUERY_STRING']}"; ?>&jezik=en">
    ...
    <?php
                        ...
                        <a href="http://e-trail.eu/<?php echo "{$fajlxx}?{$_SERVER['QUERY_STRING']}"; ?>&jezik=sr">
